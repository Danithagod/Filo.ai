...
CREATE INDEX "idx_file_index_filename_trgm" ON "file_index" USING gin ("fileName");
CREATE INDEX "idx_file_index_content_preview_trgm" ON "file_index" USING gin ("contentPreview");
...
--
-- Class SavedSearchPreset as table saved_search_preset
--
...
--
-- Class TagTaxonomy as table tag_taxonomy
--
...
--
-- Class WatchedFolder as table watched_folders
--
...
--
-- Foreign relations for "document_embedding" table
--
